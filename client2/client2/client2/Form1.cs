...
namespace client2
{
    public partial class Form1 : Form
    {
        ...
        private string serverIPAddress = "192.168.80.113"; // Replace with server's IP address
        ...
        private void CheckServerStatus()
        {
            try
            {
                ...
                udpClient.Send(data, data.Length, serverIPAddress, serverPort); // Use server IP address
            }
            catch (Exception ex)
            {
